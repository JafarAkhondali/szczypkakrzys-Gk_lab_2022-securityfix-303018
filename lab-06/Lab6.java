...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        int n = 11;
        float size = 5;
        gl2.glScalef(size, size - 1.5f, size);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float[] light1  = {0.5f, 0.5f, 0.5f, 1};
        float[] light2  = {0, 0, 1, 1};
        float[] light3  =  {0.3f, 0.2f, 0.2f, 0.3f};
        gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_DIFFUSE, light1,0);
        gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_SPECULAR, light2,0);
        gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_AMBIENT, light3,0);
